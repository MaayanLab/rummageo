    ...
    <div className="prose">
      ...
      <div className="flex">
        ...
        <Image className={'rounded float-right ml-5'} src={'/images/rummageo_logo.png'} width={250} height={250} alt={'Rummageo'}></Image>
          ...
          <p>
          We considered any GEO study aligned by <Link href="https://maayanlab.cloud/archs4/" className="underline cursor-pointer" target="_blank">ARCHS4</Link> with at least three samples per condition with at least six samples in total 
          collected for the study. Studies with more than 50 samples were discarded because such studied typically contain patient data 
          that is not amenable for simple signature computation that compares two conditions. Samples were grouped using metadata provided 
          by the GEO study. Specifically, K-means clustering of the embedding of concatenated sample <span style={{fontStyle: "italic"}}>title</span>, <span style={{fontStyle: "italic"}}>characteristic_ch1</span>, and <span style={{fontStyle: "italic"}}>source_ch1 </span>
          fields were used to classify conditions. To create condition titles, common words across all samples for each condition were retained. 
          Limma voom was used to compute differential expression signatures for each condition against all other conditions within each study. 
          Additionally, we attempted to first identify any control conditions based on metadata and a discrete list of keywords that describe 
          ...
          labeled with such term to all other condition groups. Up and down gene sets were extracted from each signature for genes with an 
          adjusted p-value of less than 0.05. If less than five genes met this threshold, the gene set was discarded. If more than 2000 genes met 
          this threshold, the threshold was lowered incrementally to 0.05, 0.01, 0.005, and 0.001, until less than 2000 genes were retained.
          </p>
          <br></br>
          <p>
