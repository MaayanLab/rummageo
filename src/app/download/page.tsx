      ...
      <div className="grid lg:grid-cols-2 gap-4 my-4">
        <a className="stats shadow" href={`${prefix}/rummageo/2.5/human-geo-auto.gmt.gz`} download="human-geo-auto.gmt.gz">
          <div className="stat gap-2">
            ...
            <span className="whitespace-nowrap">536MB compressed</span>, <span className="whitespace-nowrap">1.1G uncompressed</span>, <span className="whitespace-nowrap">Last Updated Mon Nov 4 2024</span>
            </div>
          </div>
        </a>
        <a className="stats shadow" href={`${prefix}/rummageo/2.5/human-gse-processed-meta.json`} download="human-gse-processed-meta.json">
          <div className="stat gap-2">
            ...
            <div className="stat-desc whitespace-normal">
              <span className="whitespace-nowrap">16.9MB uncompressed</span>, <span className="whitespace-nowrap">Last Updated Mon Nov 4 2024</span>
            </div>
          </div>
        </a>
        <a className="stats shadow" href={`${prefix}/rummageo/2.5/mouse-geo-auto.gmt.gz`} download="mouse-geo-auto.gmt.gz">
          <div className="stat gap-2">
            ...
            <div className="stat-desc whitespace-normal">
              <span className="whitespace-nowrap">561MB compressed</span>, <span className="whitespace-nowrap">1.1G uncompressed</span>, <span className="whitespace-nowrap">Last Updated Mon Nov 4 2024</span>
            </div>
          </div>
        </a>
        <a className="stats shadow" href={`${prefix}/rummageo/2.5/mouse-gse-processed-meta.json`} download="mouse-gse-processed-meta.json">
          <div className="stat gap-2">
            ...
            <div className="stat-desc whitespace-normal">
              <span className="whitespace-nowrap">11.6MB</span>, <span className="whitespace-nowrap">Last Updated Mon Nov 4 2024</span>
            </div>
          </div>
        </a>
