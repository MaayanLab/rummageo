## Created by: Daniel Clarke -- Table Mining Repo https://github.com/MaayanLab/TableMining/blob/main/paper_figures/common.py
...
def dump_gmt(gmt_dict, path):
  with open(path, 'w') as fw:
    for term, geneset in gmt_dict.items():
      print(term, '', *geneset, sep='\t', file=fw)
